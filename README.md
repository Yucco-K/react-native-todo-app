...
> **注意**: このデモ動画はグループ機能実装前の収録です。最新版ではグループTodo機能、招待システムなどが追加されています。
...
<img src="https://qr.expo.dev/eas-update?slug=react-native-todo-app&releaseChannel=production&host=u.expo.dev" width="200" />

> このQRコードは常に最新版に自動更新されます。
