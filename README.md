...
- Todo作成・編集・削除・完了切り替え
- **組織機能**：複数の組織（家族、仕事チームなど）を作成・管理
  - **招待システム**：招待コード（8桁）またはメールアドレスで招待
  - **ドロワーメニュー**：My Listと各組織を簡単に切り替え
  - **権限管理**：組織の作成者のみが招待・メンバー削除可能
- **プッシュ通知**：組織のTodo変更時・完了時に全メンバーに通知（通知センター対応）
...
- **通知内容**: 組織のTodoの追加・編集・削除・完了時にリアルタイムで全メンバーに通知
